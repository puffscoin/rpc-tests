...
var asyncTest = function(host, done){
    Helpers.send(host, [{
        id: config.rpcMessageId++, jsonrpc: "2.0", method: 'puffs_accounts',
    ...
    {
        id: config.rpcMessageId++, jsonrpc: "2.0", method: 'puffs_getBalance',
    ...
    {
        id: config.rpcMessageId++, jsonrpc: "2.0", method: 'puffs_gasPrice',
